 ...
 *
 */
public  class GABCL2L2SD_FLSame extends GABCL2L2S{
	int GlobalCount = 0;
	int GlobalLimit = 25;//The range of GlobalLimit is [SN/MSG,SN].
	boolean update = false;
	
	public GABCL2L2SD_FLSame(String fun, int d2, int mc, double lb, double ub) {
	  ...
	  /*Employed Bee Phase*/
	   for (i=0;i<FoodNumber;i++)
	       ...
	       // }
	        ...
	        r = (   (double)Math.random()*32767 / ((double)(32767)+(double)(1)) );
	        if(update){
	        	solution[param2change] = SolutionSelector.chooseBestOnSameFactor(
