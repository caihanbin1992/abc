...
/**
 * Great!
 * GABC with linear factor.
 * @author Jez
 *
 */
public  class GABCL2L2 extends GABC{
	public GABCL2L2(String fun, int D, int mc, double lb, double ub) {
	  ...
	  /*Employed Bee Phase*/
	   for (i=0;i<FoodNumber;i++)
	       ...
	       // }
	        ...
	        solution[param2change]=Foods[i][param2change]+(Foods[i][param2change]-Foods[neighbour][param2change])*(r-0.5)*2*(1-(double)iter/maxCycle)
